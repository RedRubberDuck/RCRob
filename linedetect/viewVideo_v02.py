...
import videoProc, drawFunction, LaneDetection
...
def main():
    ...
    inputFileName='/martie2/test6.h264'
    ...
    for frame in videoReader.readFrame():
        ...
        # if index % 3 == 0:     
            ...
            birdview_mask=cv2.resize(birdview_mask,(birdview_mask.shape[1],birdview_mask.shape[0]))
